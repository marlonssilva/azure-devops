# DevOps Users Removal

facilitate the removal of users from azure devops

Script accesses the Azure Devops API to Remove Users

Script is capable of removing users who have never accessed azure devops

Script is capable of removing users based on the last access made, you can define the acceptable time in the $Tempo_Limit variable, if the time without access is greater than or equal to the defined time, the user will be removed.
